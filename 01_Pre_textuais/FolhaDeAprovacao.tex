...
\begin{flushright}
\parbox{8cm}{
\singlespacing{Projeto de Graduação, como requisito parcial para obtenção do título de Bacharel em Engenharia Elétrica ênfase em Sistemas Eletrônico, da Universidade do Estado do Rio de Janeiro.}
}
\end{flushright}
