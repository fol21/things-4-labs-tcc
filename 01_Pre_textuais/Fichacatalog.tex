...
\singlespacing
	...
	\begin{minipage}[top]{115mm}
		...
		\phantom{XX}105\,f.\\
		\phantom{XX}\\
		\phantom{XX}Orientadores: Michel Tcheou;\\
					\hspace*{31mm} Lisandro Lovisolo.\\
       		\phantom{XX}Trabalho de Conclusão de Curso -- Universidade do Estado do Rio de Janeiro, Faculdade de Engenharia.\\
		\phantom{XX}\\
