...
\newcommand{\setTituloEnglish}{Scalable System for Internet of Things Applications using MQTT}
\newcommand{\setLocationDate}{Rio de Janeiro\\2018} % Coloque aqui a localização e data
\newcommand{\setApprovalDate}{08 de Outubro de 2018}
...
\input{./01_Pre_textuais/ListaDeSiglas.tex}
...
\input{./02_Capitulos/02_Cap1/industria_4_0.tex}
\input{./02_Capitulos/02_Cap2/ideia_geral.tex}
\input{./02_Capitulos/02_Cap3/projeto.tex}
\input{./02_Capitulos/02_Cap4/casos_de_uso.tex}
%\input{./02_Capitulos/02_Cap5/custos.tex}
...
\input{./03_Conclusao/apendices.tex}
